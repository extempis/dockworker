...
License:    Apache 2.0
URL:        https://github.com/extempis/dockworker
BuildArch:  noarch
...
install -m755 $RPM_BUILD_DIR/%{name}-%{VERSION}/dockworker $RPM_BUILD_ROOT/usr/local/bin

%files
%attr(755, root, root) /usr/local/bin/dockworker
...
# rpmbuild --target noarch -bb dockworker.spec
